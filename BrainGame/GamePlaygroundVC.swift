...
class GamePlaygroundVC: UIViewController {
    ...
    func setupMenuAfterPressPauseButtonView() {
        ...
        menuViewAfterPressPauseButton.addConstraints(withFormat: "V:|[v0(140)][v1(1)]-55-[v2(v4)]-55-[v3(v4)]-55-[v4]-55-|", views: titleGamePausedLabel, borderLineGamePausedView, resumeButton, restartButton, quitButton)
